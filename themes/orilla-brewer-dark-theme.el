...
;;; modified by Guillaume MICHEL

;;; Code:

(deftheme orilla-brewer-dark)
...
(let ((base00 "#0c0d0e")
  ...
  (custom-theme-set-faces
   ...
   `(mode-line-buffer-id ((t (:foreground ,base07 :background nil :bold t :weight ultra-bold))))
...
(provide-theme 'orilla-brewer-dark)
